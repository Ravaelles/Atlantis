    ...
    public AFocusPoint focusPoint() {
        return cache.getIfValid(
            ...
            () -> {
                ...
                if ((focus = buildingSurroundedByEnemies()) != null) return focus;
                ...
                if (
                    ...
                    if ((focus = atNaturalChoke(true)) != null) return focus;
                }
...
//                if ((focus = somewhereAtNaturalBaseOrNaturalChoke()) != null) return focus;
                ...
                if (combatUnits >= 6) {
                    if ((focus = atNaturalChoke(false)) != null) return focus;
                }
...
//                }
    ...
    private AFocusPoint buildingSurroundedByEnemies() {
        AUnit ourBuildingSurroundedByEnemies = OurBuildingSurroundedByEnemies.get();

        if (ourBuildingSurroundedByEnemies != null) {
            return new AFocusPoint(
                ourBuildingSurroundedByEnemies,
                "BuildingSurroundedByEnemies"
            );
        }
...
//            mainChoke.translateTilesTowards(0.5, Select.main()),
    ...
    private AFocusPoint atNaturalChoke(boolean force) {
        if (!force) {
