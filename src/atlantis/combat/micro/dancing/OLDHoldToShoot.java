...
import atlantis.combat.micro.dancing.hold.DragoonHoldToShoot;
...
//        if (true) return false;
        ...
        if (!unit.isAction(Actions.ATTACK_UNIT, Actions.MOVE_ATTACK)) return false;
