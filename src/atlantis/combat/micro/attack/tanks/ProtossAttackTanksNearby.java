...
public class ProtossAttackTanksNearby extends Manager {
    private AUnit tank;

    public ProtossAttackTanksNearby(AUnit unit) {
        super(unit);
    }
    ...
    public boolean applies() {
        ...
        return (tankInRange() != null)
            && (unit.lastTargetWasTank() || unit.hp() >= 80 || unit.enemiesNear().tanks().countInRadius(7, unit) > 0);
    }
