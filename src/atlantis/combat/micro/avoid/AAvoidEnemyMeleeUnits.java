...
public class AAvoidEnemyMeleeUnits extends AAvoidUnits {
    ...
    public boolean avoid() {
        ...
        if (isEnemyCriticallyClose()) {
            if (startRunningFromEnemy(unit, nearestEnemy, 3.5, "MeleeRun")) {
                return true;
            }
        }
    ...
    public double getCriticalDistance() {
        ...
        double criticalDistance = super.getCriticalDistance(nearestEnemy);

        return A.inRange(0.1, criticalDistance, 3.9);

//        if (nearestEnemy == null) {
//            return Double.NEGATIVE_INFINITY;
//        }
//
//        APainter.paintCircle(nearestEnemy.getPosition(), 16, Color.Orange);
//
