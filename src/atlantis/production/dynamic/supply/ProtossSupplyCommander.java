...
public class ProtossSupplyCommander extends Commander {
    ...
    public boolean applies() {
        return We.protoss() && A.everyNthGameFrame(11);
    }
...
//            );
        ...
        if (supplyTotal >= BuildOrderSettings.autoSupplyManagerWhenSupplyExceeds()) {
            ...
            if (supplyTotal <= 11) {
                ...
                if (supplyFree <= 5 && noSuppliesBeingBuilt || supplyFree <= 1) {
                    requestAdditionalSupply();
                }
            }
                ...
                if (supplyFree <= 10 && suppliesBeingBuilt <= 1 || supplyFree <= 1) {
                    requestAdditionalSupply();
                }
            }
