...
public class DragoonLongNotAttackedVZ extends Manager {
    public static final double MIN_S = 0;
    private AUnit enemy;

    public DragoonLongNotAttackedVZ(AUnit unit) {
        super(unit);
    }
...
//        if (true) return false;
        ...
        if (unit.meleeEnemiesNearCount(2) >= 3) return false;
        if (unit.lastPositioningActionLessThanAgo(20)) return false;
