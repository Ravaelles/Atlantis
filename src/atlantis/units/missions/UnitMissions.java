...
//    public static final UnitMission GATHER = new UnitMission();
    ...
    public static final UnitMission GATHER_GAS = new UnitMission();
    public static final UnitMission HEAL = new UnitMission();
    public static final UnitMission HOLD_POSITION = new UnitMission();
    public static final UnitMission MOVE = new UnitMission();
