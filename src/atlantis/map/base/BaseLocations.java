...
//    public static Positions startingLocationPositions() {
//        return Positions.
////        return AMap.getMap().getStartingLocations();
//    }
    ...
    public static double groundDistToNearestStartLocation(HasPosition nearestTo) {
        HasPosition nearestStarting = Positions.nearestToFrom(nearestTo, BaseLocations.startingLocations());
