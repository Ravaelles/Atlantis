...
public class Atlantis implements BWEventListener {
    ...
    public void onStart() {
        ...
        handler.setLocalSpeed(AtlantisConfig.GAME_SPEED); // Change in-game speed (0 - fastest, 20 - normal)
//        handler.setFrameSkip(2); // Number of GUI frames to skip
//        handler.setGUI(false); // Turn off GUI - will speed up game considerably
        handler.enableUserInput(); // Enable user input - without it you can't control units with mouse
